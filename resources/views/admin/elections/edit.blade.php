...
<head>
    ...
    <title>Edit Election — VoteSystem Admin</title>
...
<body class="bg-gray-50 min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <div class="bg-white border-b border-gray-200 px-8 py-4">
            ...
            <h1 class="text-xl font-extrabold text-gray-900">Edit Election</h1>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.elections.update', $election) }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                ...
                                bg-white resize-none">{{ old('description', $election->description) }}</textarea>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="datetime-local" name="start_at" required
                                    value="{{ old('start_at', $election->start_at->format('Y-m-d\TH:i')) }}"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm
                                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_at" required
                                    value="{{ old('end_at', $election->end_at->format('Y-m-d\TH:i')) }}"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm
                                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white">

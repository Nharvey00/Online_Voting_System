...
<head>
    ...
    <title>Edit Position — VoteSystem Admin</title>
...
<body class="bg-gray-50 min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <div class="bg-white border-b border-gray-200 px-8 py-4">
            ...
            <h1 class="text-xl font-extrabold text-gray-900">Edit Position</h1>
        ...
        <main class="flex-1 p-8">
            ...
            <div class="max-w-xl">
                <div class="bg-white border border-gray-200 rounded-lg p-6">
                    <form method="POST" action="{{ route('admin.positions.update', [$election, $position]) }}" class="space-y-5">
                        @csrf @method('PUT')
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="max_winners" value="{{ old('max_winners', $position->max_winners) }}" min="1" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm
                                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white">
                            ...
                            <div>
                                ...
                                <input type="number" name="order" value="{{ old('order', $position->order) }}" min="0" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm
                                    focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white">
